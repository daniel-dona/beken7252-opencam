...
#define AUDIO_DSP_SAMPLERATE                1                       /*  ²ÉÑùÆµÂÊ                    */
...
#define AUDIO_DEVICE_MP_CNT                 (2)
// #define AUDIO_DEVICE_DECODE_MP_BLOCK_SZ     (4352 * 2)
#define AUDIO_DEVICE_DECODE_MP_BLOCK_SZ     (2048 * 2)
...
#define CODEC_CMD_SET_CHANNEL       4
#define CODEC_CMD_EQ                5
