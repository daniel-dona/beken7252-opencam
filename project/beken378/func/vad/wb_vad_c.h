...
#define FRAME_LEN                    320           /* Length (samples) of the input frame */
#define SUB_BAND_CNT                 12              /* Number of sub-bands used by VAD */
...
#define THR_MIN     (2.6f*SCALE)   /* Minimum threshold */

#define THR_HIGH   (100.0f*SCALE)   /* Highest threshold */
#define THR_LOW    (3.7f*SCALE)    /* Lowest threshold */

#define NO_P1      30744.0f          /* ilog2(1), Noise level for highest threshold */
#define NO_P2      21786.0f          /* ilog2(0.1, Noise level for lowest threshold */
...
#define SP_P1             27527.0f          /* ilog2(NOM_LEVEL/4) */
#define SP_P2             11832.0f          /* ilog2(NOM_LEVEL*4) */
...
#define VAD_POW_LOW                25000000.0f    /* If input power is lower than this, VAD is set to 0 */
