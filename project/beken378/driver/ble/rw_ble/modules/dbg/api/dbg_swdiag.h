...
*/
    ...
    DBG_SWDIAG_SCOMMON_EVT_START_OFFSET              = 0,
    DBG_SWDIAG_SCOMMON_EVT_START_MASK                = 0x01,

    DBG_SWDIAG_SCOMMON_EVT_STOP_OFFSET               = 1,
    DBG_SWDIAG_SCOMMON_EVT_STOP_MASK                 = 0x02,

    DBG_SWDIAG_SCOMMON_EVT_CANCELED_OFFSET           = 2,
    DBG_SWDIAG_SCOMMON_EVT_CANCELED_MASK             = 0x04,

    DBG_SWDIAG_SCOMMON_FRM_ISR_OFFSET                = 3,
    DBG_SWDIAG_SCOMMON_FRM_ISR_MASK                  = 0x08,

    DBG_SWDIAG_SCOMMON_RESCHED_OFFSET                = 4,
    DBG_SWDIAG_SCOMMON_RESCHED_MASK                  = 0x10,

    DBG_SWDIAG_SCOMMON_UPDATE_OFFSET                 = 5,
    DBG_SWDIAG_SCOMMON_UPDATE_MASK                   = 0x60,

    DBG_SWDIAG_SCOMMON_AUDIO_ISR_OFFSET              = 7,
    DBG_SWDIAG_SCOMMON_AUDIO_ISR_MASK                = 0x80,
