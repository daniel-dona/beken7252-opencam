#ifndef _api_export_h_
#define _api_export_h_
...
#define BLE_ADDR_LEN     (6)         /**< Length of Bluetooth Device Address. */
#define STR_MODEL_LEN   (20 + 1)    /**< Reserved. */
#define STR_SEC_LEN     (40 + 1)    /**< Length of secret. */
#define STR_VER_LEN     (8 + 1)     /**< Length of version. */
#define STR_DEV_KEY_LEN     (20 + 1)    /**< Length of secret. */
#define STR_DEV_SEC_LEN     (32 + 1)    /**< Length of secret. */
...
struct device_config {
    uint8_t bd_addr[BLE_ADDR_LEN];               /**< Bluetooth Device Address. */
    ...
    bool encrypt_type;
    char dev_key[STR_DEV_KEY_LEN];
    char dev_secret[STR_DEV_SEC_LEN];
};
/**
