...
struct anps_env_tag
{
    ...
    kernel_state_t state[ANPS_IDX_MAX];
 ...
 ****************************************************************************************
 */
void anps_send_cmp_evt(kernel_task_id_t src_id, kernel_task_id_t dest_id, uint8_t operation, uint8_t status);
...
extern const struct kernel_state_handler anps_default_handler;
