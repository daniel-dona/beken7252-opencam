/*
 * File      : rt_ota_flash_stm32f2_port.c
...
#ifdef RT_OTA_FLASH_PORT_DRIVER_STM32F2
#include <stm32f2xx.h>
...
const struct rt_ota_flash_dev stm32f2_onchip_flash = { "stm32_onchip", 0x08000000, 1024*1024, {read, write, erase} };
#endif /* RT_OTA_FLASH_PORT_DRIVER_STM32F2 */
